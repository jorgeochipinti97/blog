...
export const messages = {
  en: {
    ...
    home: {
      ...
      live: 'Live',
      onfit: 'On Fit',
      onFitDesc: 'Suite for gym chains: web, backoffice, sales landings, and chatbots',
      ...
      katch: 'Katch',
      katchDesc: 'Logistics platform with real-time geolocation: optimized routes, driver tracking, and pickup points',
      ...
      tribuna: 'Tribuna',
      tribunaDesc: 'Sports management media platform',
      dublinCloud: 'Dublin Cloud',
      dublinCloudDesc: 'Web and mobile infrastructure as a service',
  ...
  es: {
    ...
    home: {
      ...
      live: 'Activo',
      onfit: 'On Fit',
      onFitDesc: 'Suite para cadenas de gimnasios: web, backoffice, landings de venta y chatbots',
      aduesSport: 'Adues Sport',
      ...
      katch: 'Katch',
      katchDesc: 'Plataforma logística con geolocalización en tiempo real: rutas optimizadas, seguimiento de choferes y puntos de pickeo',
      cmsAiBoosted: 'CMS AI Boosted',
      ...
      tribuna: 'Tribuna',
      tribunaDesc: 'Medio de gestión deportiva',
      dublinCloud: 'Dublin Cloud',
      dublinCloudDesc: 'Venta de infraestructura web y mobile como servicio',
      multimediosCanning: 'Multimedios Canning',
